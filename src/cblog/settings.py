...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.crspcl1n6prl.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstonesayhanblog' # please enter your s3 bucket name
